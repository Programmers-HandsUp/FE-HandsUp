  ...
  return (
    <section>
      {data.content.map((content) => (
        <div
          className="relative w-[50%] h-full group"
          key={content.chatRoomId}>
          <div className="absolute top-0 bg-gray-500 rounded-full w-full  h-full pr-2 transition-all group-hover:scale-x-150 origin-left"></div>
